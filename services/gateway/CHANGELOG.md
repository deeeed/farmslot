...
- fix(gateway): harden inline CI-fix dispatch so deferred runner nudges do not create phantom CI-fix contexts, make generated CI-fix marker completion write the role signal reliably, and prevent Codex shell launch text from being misclassified as an auth blocker.
