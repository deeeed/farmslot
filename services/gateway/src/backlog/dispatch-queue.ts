...
export function addItem(
  ...
  const item: QueueRecord = {
    ...
    reviewAutoFinish: params.reviewAutoFinish,
    publishReview: params.publishReview,
...
export function buildQueuePreviewParams(item: QueueItem) {
  ...
  return {
    ...
    ...(item.reviewAutoFinish !== undefined ? { reviewAutoFinish: item.reviewAutoFinish } : {}),
    ...(item.publishReview !== undefined ? { publishReview: item.publishReview } : {}),
