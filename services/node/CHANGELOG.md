...
- fix(exec): resolve the operator login PATH once and reuse it in non-login command shells, preventing frequent resource health probes from repeatedly sourcing expensive shell startup files.
