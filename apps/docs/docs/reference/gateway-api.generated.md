...
| `assessment.suggestion.analyze`         | assessment       | bounded-write | —      | —      | Assessment Suggestion Analyze gateway method.         |
| `assessment.suggestion.preview`         | assessment       | read-only     | —      | —      | Assessment Suggestion Preview gateway method.         |
...
| `dispatch.pressureAdmission.get`        | dispatch         | read-only     | —      | —      | Dispatch PressureAdmission Get gateway method.        |
| `dispatch.pressureAdmission.setEnabled` | dispatch         | bounded-write | —      | —      | Dispatch PressureAdmission SetEnabled gateway method. |
