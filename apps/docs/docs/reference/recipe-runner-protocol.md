...
Actions may declare `adapters` when support differs by adapter; validation rejects other active adapters before execution and names the supported alternatives.
