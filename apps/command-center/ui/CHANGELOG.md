...
- The model picker loads each runner's catalog on demand, saves which models appear by default, and says when a runner has no catalog or the catalog cannot be read.
