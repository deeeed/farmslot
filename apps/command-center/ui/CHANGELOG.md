...
- fix(backlog): share backlog metadata and dispatch controls across create/edit, keep run mode explicit, require an owner under multi-project creation scope, and scope templates/slots to that owner.
