...
- feat(runs): Run Detail lists each agent context's runner session with its runner, model, short session id, structured liveness, and copy buttons for the gateway-built reopen and tmux attach commands.
