...
- Show blocked workers how to restart on an available worker after slot release, or resume monitoring after a fresh signal and proof-resource check while they still own the slot.
