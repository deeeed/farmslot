    ...
    runs: [
      {
        ...
        decisions: [
          {
            id: 'dec-root-publish-gate',
            type: 'engine_human_gate',
            title: 'Run run-root — publish gate',
            description: 'Local package is ready for human publication approval',
            ...
            payload: {
              ...
              prNumber: 27901,
              repo: 'example-org/example-mobile',
              diffStat: { files: 4, additions: 58, deletions: 11 },
              workerReport:
                'Implemented retry handling around SecureKeychain.get() during biometric prompt completion.',
              branch: 'fix/proj-2501',
              slotId: 'runner-local-mobile-1',
              ...
              prPackage: {
                ...
                diffStat: { files: 4, additions: 58, deletions: 11 },
                draftTitle: 'fix: resolve PROJ-2501 keychain race',
                draftBody: 'Fix keychain race handling.',
                evidenceManifest: [
                  { path: 'artifacts/before.png', purpose: 'screenshot' },
                  { path: 'artifacts/after.png', purpose: 'screenshot' },
                ],
                ...
                gatePolicy: {
                  ...
                  publishAuthority: 'human',
                  reason: 'Human publication approval',
                },
                publicationTarget: 'ready',
                publicationStatus: 'not_published',
                createdAt: generatedAt,
