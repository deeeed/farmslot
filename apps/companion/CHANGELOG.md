...
- feat(runs): Run Detail shows one compact line when a run is queued behind a fleet-scoped resource claim — the capability, the claim, the place in line, and the run holding it.
