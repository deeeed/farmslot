...
export function NativeConnectionScreen({
  ...
  return (
    // The manual gateway form sits at the bottom; keep its fields reachable above the keyboard.
    <KeyboardAvoidingView
      style={connectionStyles.page}
    ...
    >
      ...
      >
        ...
        {vm.pairingImportMessage ? (
          <Text style={styles.muted}>{vm.pairingImportMessage}</Text>
        ) : null}
