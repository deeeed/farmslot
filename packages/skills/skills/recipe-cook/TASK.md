...
> Compatibility harness path for runners that expect `recipe-cook/TASK.md`.
...
- the cooking run edits `recipe-cook/SKILL.md`, `recipe-cook/TASK.md`, or `recipe-cook/repos/*.md`
