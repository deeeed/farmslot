...
metadata:
  ...
  outputs: artifacts/recipe.json artifacts/recipe-cook.json artifacts/recipe-cook-learning.json
...
- Do not edit `recipe-cook/SKILL.md`, `recipe-cook/references/TASK.md`, or `recipe-cook/repos/*.md` during the cooking run
...
If the current repo has an `recipe-cook` harness, execute through it.
