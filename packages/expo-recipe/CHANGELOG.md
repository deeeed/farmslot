...
- fix: verify Android `ui.set_input` replacement, preserve exact whitespace, tolerate provider-verified masked fields, and clear retained controlled-input text before retrying.
