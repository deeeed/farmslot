...
- feat(resources): add bounded normalized pressure history, ownership-safe process inventory and attribution contracts, plus the typed `resource.pressure.snapshot` RPC.
