...
- feat(visual-review): define portable source and feedback documents for hierarchical full-surface or explicit viewport captures, typed multi-path navigation edges, and normalized color-coded point and area annotations.
