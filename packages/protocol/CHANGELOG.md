...
- fix(runs): expose structured publication-review launch rejections in ready-gate payloads and persisted publish-gate state so clients can present recoverable dirty-tree and stale-HEAD guidance.
