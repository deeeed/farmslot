...
- feat: `contracts/slot-selection.ts` — operator slot availability + selection core (`selectSlot`, `slotUnavailableReason`, `slotSelectionScore`, `cdpLive`), the TypeScript port of the `scripts/find-slot.sh` decision logic.
