...
- Diff views classify changed files as `code` or `test`: `DEFAULT_TEST_FILE_PATTERNS`, `compileTestFileMatcher`, `summarizeDiffKinds`, and a `kind` on each `git.branchDiff` file.
