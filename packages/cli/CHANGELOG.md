...
- feat(machine): add machine pause and restore previews, explicit execution with reviewed targets, durable status, selection controls, and partial-failure envelopes.
