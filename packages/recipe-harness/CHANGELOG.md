...
- feat(visual-review): provide a lightweight project-agnostic review-board builder, recipe-artifact converter, and dynamic-port server with a typed navigation map plus color-coded, movable point and drag-area annotations.
