...
- Add canonical `recipes/<adapter>/<domain>/*.recipe.json` discovery, reserve top-level adapter directory names, preserve stable ids, and retain temporary legacy filename-suffix compatibility.
