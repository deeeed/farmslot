...
- fix: retry DOM-settlement and compositor probes when navigation invalidates their frame or execution context, reporting transient or superseded probe races as suspended results or warnings instead of throws or false success.
