...
```bash
farmslot-agent task init <task-dir> --flow fix-bug --platform mobile --template fix-bug/autonomous.mobile --package-templates <catalog> --title "…" --task-text "…" [--run-mode <mode>]
