...
| Textual acceptance criteria / evidence | Opt-in advisory text-only assessment shipped in #730; visual/mixed proof refused; authoritative ledger unchanged | Independent v2 labels agreed; the operator-recorded v3 read agreed on 12/12 text cases (session provenance unverified); the v2 Jev adapter probe was 8/9 with a wrong definite `supported` verdict on insufficient evidence | None                                                                                                                                                                                | Hold Jev for this consumer; v3 needs actual gateway receipts, an independent provider-quality gate and paired validation before any benefit claim |
