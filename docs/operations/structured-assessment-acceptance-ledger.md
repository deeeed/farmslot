...
PR #736 adds offline first-read and read/turn diagnostics, but its revised draft
corpus failed a source-only label review. A metadata-only worker chose a required
first source in 6/8 cases. No new advice calls or paired workflow results were
produced. The draft stays unsealed and the efficiency claim remains on hold.
