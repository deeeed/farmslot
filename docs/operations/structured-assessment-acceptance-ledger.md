...
| Static-review checklist                | Synthetic-only, opt-in gateway-store pilot; no review-worker RPC                                                 | [v2 synthetic study](../../scripts/static-review-assessment/README.md): Jev 8/8 held-out, 4/4 development, correct violation locations; label read identity not attested    | None                                                                                                                                                                                | Pair actual reviews against one frozen PR head at equal independently judged quality; routine calls remain off                             |
