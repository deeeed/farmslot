...
| `assessment.suggestion.preview` | rpc-only |             |     | Read-only preview of an explicitly admitted checklist, Co-Pilot context or review-routing suggestion; use farmslot rpc assessment.suggestion.preview. |
| `assessment.suggestion.analyze` | rpc-only |             |     | Confirmed opt-in assessment of the previewed packet; use farmslot rpc assessment.suggestion.analyze.                                                  |
...
| `copilot.configure`         | rpc-only |             |     | Shared Co-Pilot runtime configuration is client-neutral; use `farmslot rpc copilot.configure [json]` until a typed CLI lifecycle command is promoted. |
...
| `runtime.capability.acquire`  | typed-command | `farmslot resource capability acquire`   |     |                                                                                                                                                            |
| `runtime.capability.release`  | typed-command | `farmslot resource capability release`   |     | Also used by the Command Center runtime-capabilities panel.                                                                                                |
...
| `runtime.capability.stopWarm` | typed-command | `farmslot resource capability stop-warm` |     | Also used by the Command Center Slot View to stop a warm provider.                                                                                         |
| `runtime.posture.status`      | typed-command | `farmslot resource posture status`       |     |                                                                                                                                                            |
| `runtime.posture.preview`     | typed-command | `farmslot resource posture preview`      |     |                                                                                                                                                            |
| `runtime.posture.apply`       | typed-command | `farmslot resource posture apply`        |     |                                                                                                                                                            |
