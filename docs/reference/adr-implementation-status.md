...
| UI manifest-first rendering (no filename inference fallback)                              | Shipped     | Valid typed manifests are the rendering source of truth; invalid/missing manifests use the explicit legacy scan fallback                                                |
