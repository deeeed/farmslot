...
| Cursor/Grok hook path                               | Partial  | Cursor remains `pane-only`; Grok activity remains pane-backed while exact prompt acceptance uses its native session history with generic worker-signal fallback                                                                                                         |
