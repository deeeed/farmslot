...
| [049](../adr/049-agent-execution-template-selection.md)    | Agent execution template selection | Proposed   | Shipped        | Flip ADR body to Accepted (implementation landed in PR #347)         |
