...
- 2026-06-12 priority update: gateway intelligence from Command Center is covered. The human gate after a task completes in a ready or PR-review workspace is still the most important missing demo and must not be re-added until the actual visible evidence is clean.
